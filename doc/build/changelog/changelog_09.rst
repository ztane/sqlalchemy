...
.. changelog::
    ...
    .. change::
        ...
        Support has been added for py.test to run tests.   This runner
        is currently being supported in addition to nose, and will likely
        be preferred to nose going forward.   The nose plugin system used
        by SQLAlchemy has been split out so that it works under py.test as
        ...
        When using py.test as the test runner, the system will also run
